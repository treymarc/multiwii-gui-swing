...
public class MSP {
	...
	public static void setModel(DataMwiiModel model) {
		MSP.model = model;
	}
  ...
  public static final int
	...
	private static void decode(int stateMSP2) {
		...
		case MOTOR:
			...
			break;
		case RC:
			// rcRoll = read16();rcPitch = read16();rcYaw = read16();rcThrottle
			// = read16();
		...
		case BAT:
			...
			break;
		case RC_TUNING:
			getModel().setRC_RATE((int) (read8() / 100.0));
			getModel().setRC_EXPO((int) (read8() / 100.0));
	...
	public static String request(int msp) {
	...
	public static String request(int msp, Character[] payload) {
		if(msp < 0) {
			return null; 
		}
